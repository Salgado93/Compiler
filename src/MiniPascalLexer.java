...
public class MiniPascalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "COMMENT", "WS", "PROGRAM", "VAR", "CONST", "BEGIN", "END", "FUNCTION", 
			"PROCEDURE", "IF", "THEN", "ELSE", "FOR", "TO", "DOWNTO", "DO", "WHILE", 
			"REPEAT", "UNTIL", "READ", "READLN", "WRITE", "WRITELN", "ARRAY", "OF", 
			"NOT", "AND", "OR", "DIV_KW", "MOD", "TRUE", "FALSE", "INTEGER", "REAL", 
			"STRING", "BOOLEAN", "ID", "NUM", "STRING_LITERAL", "PLUS", "MINUS", 
			"MULT", "DIV", "ASSIGN", "EQ", "NEQ", "LT", "GT", "LTE", "GTE", "LPAREN", 
			"RPAREN", "LBRACK", "RBRACK", "SEMICOLON", "COLON", "COMMA", "DOT"
		};
	}
